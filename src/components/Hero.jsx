...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="hidden lg:flex flex-col gap-5 fixed left-8 top-1/2 -translate-y-1/2 z-50">
        <a 
      ...
      {/* Content Container */}
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-16 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          <h1 
            data-aos="fade-up"
            className="text-white text-3xl sm:text-4xl md:text-6xl font-black mb-5 tracking-tight leading-tight"
          >
            {heroContent.greeting}, <br /> 
            <span className="text-[#ff2a2a] drop-shadow-[0_0_20px_rgba(255,42,42,0.4)] font-black">
          ...
          <p 
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-white/80 text-sm md:text-lg font-medium mb-10 max-w-xl leading-relaxed drop-shadow-md"
          >
        ...
        >
          ...
          <span className="text-white text-[11px] md:text-xs font-bold tracking-widest uppercase opacity-80 group-hover:opacity-100 transition-opacity">
