...
const PythonIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-[11px] font-bold text-white/90 uppercase tracking-wider">Python</span>
  </div>
);
...
const SqlIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-[11px] font-bold text-white/90 uppercase tracking-wider">SQL</span>
  </div>
);
...
const JavaIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-[11px] font-bold text-white/90 uppercase tracking-wider">Java</span>
  </div>
);
...
const DsaIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-[11px] font-bold text-white/90 uppercase tracking-wider">DSA</span>
  </div>
);
...
const AiCvIcon = () => (
  <div className="flex flex-col items-center gap-2">
    ...
    <span className="text-[11px] font-bold text-white/90 uppercase tracking-wider">AI & Vision</span>
  </div>
);
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div className="flex flex-col items-center w-full md:w-[350px] shrink-0 mt-12 md:mt-0">
          ...
          <div data-aos="drop-bounce" className="relative flex justify-center w-full">
            ...
            {/* Badge Card */}
            <div className="bg-gray-950 border border-white/10 w-full max-w-[280px] rounded-2xl p-3.5 shadow-[0_25px_50px_rgba(0,0,0,0.5)] relative z-20 transform -rotate-3 hover:rotate-0 transition-transform duration-500">
              {/* Cutout Hole */}
              <div className="absolute -top-3.5 left-1/2 w-16 h-6 bg-gray-950 border-t border-x border-white/10 rounded-t-xl transform -translate-x-1/2 flex justify-center items-center">
                <div className="w-8 h-2 bg-black/40 rounded-full shadow-inner"></div>
              </div>
              {/* Image Container */}
              <div className="w-full aspect-[3/4] overflow-hidden rounded-xl bg-gray-900 border border-white/10 shadow-inner">
                <img 
                  src={stackImage} 
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
          ...
          <div className="flex flex-wrap items-center gap-4 md:gap-5 mt-4">
            ...
            <div data-aos="zoom-in" data-aos-delay="400" className="bg-black/30 backdrop-blur-md border border-white/15 hover:border-white/40 hover:-translate-y-1 hover:bg-black/40 hover:shadow-[0_12px_30px_rgba(0,0,0,0.4)] transition-all duration-300 rounded-2xl p-3 md:p-4 cursor-pointer">
              <SqlIcon />
            </div>
            <div data-aos="zoom-in" data-aos-delay="500" className="bg-black/30 backdrop-blur-md border border-white/15 hover:border-white/40 hover:-translate-y-1 hover:bg-black/40 hover:shadow-[0_12px_30px_rgba(0,0,0,0.4)] transition-all duration-300 rounded-2xl p-3 md:p-4 cursor-pointer">
              <JavaIcon />
            </div>
            <div data-aos="zoom-in" data-aos-delay="600" className="bg-black/30 backdrop-blur-md border border-white/15 hover:border-white/40 hover:-translate-y-1 hover:bg-black/40 hover:shadow-[0_12px_30px_rgba(0,0,0,0.4)] transition-all duration-300 rounded-2xl p-3 md:p-4 cursor-pointer">
              <DsaIcon />
            </div>
            <div data-aos="zoom-in" data-aos-delay="700" className="bg-black/30 backdrop-blur-md border border-white/15 hover:border-white/40 hover:-translate-y-1 hover:bg-black/40 hover:shadow-[0_12px_30px_rgba(0,0,0,0.4)] transition-all duration-300 rounded-2xl p-3 md:p-4 cursor-pointer">
              <AiCvIcon />
            </div>
          </div>
